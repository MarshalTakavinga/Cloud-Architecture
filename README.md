...
[Case Study 3 — Healthcare Platform](case-study-03-healthcare-platform/) is complete — all 13 steps done, see its README for the full breakdown. The next case study to pick up (1, 2, 4, 5, or 6) hasn't been chosen yet.
