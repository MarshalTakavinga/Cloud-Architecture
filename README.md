...
Nothing is in progress right now. [Case Study 1 — Global E-Commerce Platform](case-study-01-ecommerce-platform/), [Case Study 2 — Banking Modernization](case-study-02-banking-modernization/), and [Case Study 3 — Healthcare Platform](case-study-03-healthcare-platform/) are all complete — see each case study's README for the full breakdown. Case Studies 4, 5, and 6 have not yet started; Case Study 4 (Manufacturing/IoT) is next in line.
