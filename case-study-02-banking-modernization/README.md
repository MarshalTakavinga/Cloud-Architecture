...
**Angle:** Core banking or payments workload — strong security, resiliency, and regulatory-reporting angle — a natural fit for the mainframe workload-placement question.
...
| 3. Requirements and NFRs | Not started |
| Current-state architecture | Not started |
